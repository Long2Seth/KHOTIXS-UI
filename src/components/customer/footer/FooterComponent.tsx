        ...
        <>
            {
                isLoading ? <FooterSkeletonComponent/> :
                    <footer className="w-full bg-white dark:bg-khotixs-background-dark py-[100px]">
                        ...
                        {/* Main Footer Section */}
                        <section
                            className="container mx-auto text-gray-400 grid md:grid-cols-2 xl:grid-cols-4 justify-center md:justify-between gap-y-20 ">
                            ...
                            {/* Event Category */}
                            <div className="w-[200px] ">
                                <h3 className="font-bold text-lg mb-4 text-primary-color-text dark:text-secondary-color-text  ">Event
                                    Category</h3>
                            ...
                            {/* Support & Information */}
                            <div className="w-[200px] ">
                                <h3 className="font-bold text-lg mb-4 text-primary-color-text dark:text-secondary-color-text  ">Support
                                    & Information</h3>
                                <ul className="space-y-2">
                                    <li>How to use?</li>
                                    <li>Policy</li>
                            ...
                            <div className="w-[200px] ">
                                <h3 className="font-bold text-lg mb-4 text-primary-color-text dark:text-secondary-color-text  ">Sponsors
                                    By</h3>
                                ...
                                <h3 className="font-bold text-lg mb-4 text-primary-color-text dark:text-secondary-color-text  ">Organize
                                    By</h3>
                                <div>
                                    <Image
                                        width={300}
