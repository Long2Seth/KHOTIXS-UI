        ...
        <>
            {
                isLoading ? <ContactSkeletonComponent/> :
                    <section
                        className=" flex flex-col space-y-[50px] md:space-y-[80px] xl:space-y-[100px] mb-[50px] md:mb-[80px] xl:mb-[100px] bg-khotixs-background-white dark:bg-khotixs-background-dark ">
                        {/* Hero section */}
                                        ...
                                        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <Input
                                                    ...
                                                    className="p-2 text-lg border-gray-300 rounded-[6px] dark:border-label-description placeholder:text-gray-300
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <textarea
                                                    ...
                                                    className="p-2 text-lg border border-gray-300 rounded-[6px] dark:border-label-description placeholder:text-gray-300
