                ...
                isLoading ? <AboutUsSkeletonComponent/> :
                    <section>
                        ...
                        <section className="relative h-[400px] xl:h-[600px] w-full overflow-x-hidden">
                            <div className="absolute bg-primary-color h-[400px] xl:h-[600px] w-[520px] rounded-bl-[100%] left-[-200px] overflow-x-hidden"></div>
                        ...
                        <section className="container mx-auto flex justify-center w-full h-auto text-secondary-color dark:text-secondary-color-text">
                            <section className="grid justify-center w-full gap-5 grid-cols-1 max-w-[350px] px-5 md:grid-cols-2 md:max-w-full md:px-[40px]">
                                <section className="bg-secondary-color-text flex flex-col w-full justify-center text-center max-w-full px-10 py-10 rounded-[5px] gap-y-5 md:max-w-[460px] lg:max-w-full dark:bg-secondary-color">
                                    {/* Icon */}
                                    ...
                                    <p className="text-center px-[15px] text-md xl:text-xl text-primary-color-text dark:text-secondary-color-text">
                                        ...
                                        to make every event accessible, every booking easy, and every experience unforgettable.
                                    </p>
                                </section>
                                <section className="bg-white text-center max-w-full flex flex-col justify-center px-10 py-10 rounded-[5px] gap-y-5 md:max-w-[460px] lg:max-w-full dark:bg-secondary-color">
                                    {/* Icon */}
                                    ...
                                    <p className="text-center px-[15px] text-md xl:text-xl text-primary-color-text dark:text-secondary-color-text">
                                        ...
                                        vibrant culture and creativity of the nation. We envision a future where KHOTIXXS is the
                        ...
                        <section className="container mx-auto w-full h-auto my-20 text-secondary-color dark:text-secondary-color-text">
                        ...
                        <section className="container mx-auto w-full h-auto text-secondary-color dark:text-secondary-color-text">
                            ...
                            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-center items-center w-full gap-5 px-5">
                                {MemberData.map((mentor) => (
                                    <div className="flex flex-col justify-center items-center w-[300px] mx-auto sm:w-auto " key={mentor.name}>
                                        <p className="text-[12px] md:text-lg xl:text-2xl font-semibold uppercase my-[8px]">
                                            {mentor.name}
                                        </p>
                                        <div className="flex gap-[5px] justify-center items-center">
