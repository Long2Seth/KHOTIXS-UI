            ...
            <section className="w-full lg:w-[670px] flex flex-col gap-5">
                ...
                <section>
                    <div className="flex gap-[10px] pt-[10px]">
                        <Button
                            className="w-full hover:bg-label-paid hover:bg-opacity-20 p-[12px] text-red-600 border-[1px] border-red-600 dark:bg-khotixs-background-dark dark:text-red-600 dark:border-red-600 rounded-[6px] "
                            onClick={() => router.back()}
                        >
                            Back
                        </Button>
