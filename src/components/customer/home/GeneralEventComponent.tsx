                ...
                isLoading ? <CardEventSkeletonComponent/> :
                    <section
                        ...
                        <section className=" w-full flex flex-col justify-center items-center ">
                            <h1 className="text-description-color  lg:text-2xl xl:text-3xl 2xl:text-5xl font-bold dark:text-secondary-color-text ">
                                GENERAL EVENT
                            </h1>
                            <p className=" px-[20px] text-description-color py-[8px] lg:max-w-[700px] xl:max-w-[60%] text-sm md:px-[120px] md:text-md lg:text-lg xl:text-xl xl:px-[10px] 2xl:text-xl font-light  text-center ">
