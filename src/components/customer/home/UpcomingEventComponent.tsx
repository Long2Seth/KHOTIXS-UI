    ...
    return (
        <section
            ...
            <section className=" w-full flex flex-col justify-center items-center ">
                ...
                <p className=" text-description-color text-base md:text-lg xl:text-xl max-w-[500px] lg:max-w-[700px] xl:max-w-[60%] sm:px-0 md:text-md lg:text-lg font-light text-center dark:text-dark-description-color  ">
            ...
            <section
                className=" grid grid-cols-1 md:grid-cols-2 gap-2 sm:px-[100px] md:px-[0px] md:gap-5 lg:px-[190px] xl:px-[220px] ">
