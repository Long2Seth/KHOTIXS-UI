    ...
    return (
        <div className="relative w-full flex items-center">
            ...
            {searchTerm && results.length > 0 && (
                <ul ref={resultsRef}
                    className="absolute bg-transparent top-full mt-1 max-h-[500px] overflow-y-auto left-0 w-full bg-white border-gray-300 border-0 rounded-b-[5px] z-40 text-base lg:text-lg no-scrollbar md:pl-5 pl-2 lg:pl-2 xl:pl-5">
