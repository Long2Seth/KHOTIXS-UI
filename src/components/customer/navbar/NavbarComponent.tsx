        ...
        <>
            {isLoading ? <SkeletonNavbarComponent /> :
                <nav className="w-full top-[-60px] sticky z-50 bg-white flex flex-col dark:bg-khotixs-background-dark">
                    <section className="container mx-auto w-full h-[60px] bg-white py-[10px] flex px-5 lg:px-10 justify-center gap-5 dark:bg-khotixs-background-dark">
                    ...
                    <section className="container mx-auto w-full py-[15px] px-5 lg:px-10">
                        <div className="flex justify-between h-14 items-center">
                            ...
                            {currentPath !== '/search' && (
                                <section className="rounded-[5px] flex justify-center drop-shadow-xl">
                                    <form className="w-full rounded-[5px] bg-gray-50 flex items-center" onSubmit={handleSearch}>
