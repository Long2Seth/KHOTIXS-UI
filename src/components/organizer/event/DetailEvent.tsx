        ...
        <section className="space-y-6 ">
            ...
            <div className='bg-white dark:bg-khotixs-background-dark dark:border dark:border-white rounded-[6px]'>
                <section className="p-6 space-y-6">
                    ...
                    <div className="items-end flex flex-col md:grid md:grid-cols-2 md:flex-row gap-4">
                        <section className="space-y-6order-last md:-order-1 min-w-[50%] justify-start items-start ">
                                ...
                                <section className="space-y-4">
                                    <section className="space-y-2">
                                        ...
                                        <div
                                            ...
                                            <span
                                                className="text-description-color text-sm md:text-base xl:text-lg dark:text-dark-description-color">{eventData?.startedDate}</span>
                                        </div>
                                        <div
                                            className="flex items-center gap-2 text-muted-foreground dark:text-label-text-primary">
                                    ...
                                    <section className="space-y-2">
                                        ...
                                        <div
                                            ...
                                            <span
                                                className="text-description-color text-sm md:text-base xl:text-lg dark:text-dark-description-color">{eventData?.location}</span>
                                        </div>
                                    </section>
                                </section>
                                {/* Event Description*/}
