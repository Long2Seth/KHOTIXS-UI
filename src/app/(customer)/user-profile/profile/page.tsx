        ...
        <section>
            <div>
                ...
                <div className="container mx-auto p-4">
                    <h1 className=" w-[1200px] mx-auto h-auto flex justify-start items-start text-3xl font-bold text-[#4A0635] mb-6">MY PROFILE</h1>
                                    ...
                                    <div>
                                        <Dialog>
                                            <DialogTrigger asChild>
                                                <Button variant="outline" className="bg-primary-color rounded-[5px] text-secondary-color-text font-[10px]">EDIT</Button>
                                            </DialogTrigger>
